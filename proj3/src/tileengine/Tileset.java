...
public class Tileset {
    ...
    public static final TETile AVATAR_2 = new TETile('%', Color.white, Color.black, "you", 0);
    public static final TETile AVATAR_3 = new TETile('$', Color.white, Color.black, "you", 0);
    public static final TETile WALL = new TETile(' ', new Color(216, 128, 128), Color.darkGray,
            "wall", 1);
    public static final TETile FLOOR = new TETile('.', new Color(30, 144, 255), Color.black, "floor", 2);

    public static final TETile LIGHT_0 = new TETile('.', new Color(30, 144, 255), new Color(0, 138, 255), "floor", 2);
    public static final TETile LIGHT_1 = new TETile('.', new Color(30, 144, 255), new Color(0, 109, 200), "floor", 2);
    public static final TETile LIGHT_2 = new TETile('.', new Color(30, 144, 255), new Color(0, 82, 152), "floor", 2);
